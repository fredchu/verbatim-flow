...
TERMINOLOGY_RULES = [
    ...
    (r'\bBranch\s+ASR\b', 'Breeze ASR', re.IGNORECASE | re.ASCII),
    (r'\bBri[sc]e\s+SRT\b', 'Breeze ASR', re.IGNORECASE | re.ASCII),
    (r'\b(?:Qu(?:[ai]nt|een)|Crane)\s*3?\s*8\s*B\b', 'Qwen3 8B', re.IGNORECASE | re.ASCII),
    ...
    (r'\bLLM\s+Studio\b', 'LM Studio', re.IGNORECASE | re.ASCII),
    (r'\bEmra\s*X\b', 'MLX', re.IGNORECASE | re.ASCII),
